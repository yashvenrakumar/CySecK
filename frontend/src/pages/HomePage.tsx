...
const styles: Record<string, CSSProperties> = {
  ...
  title: { margin: 0, fontSize: "25px", color: "#273243" },
  sub: { marginTop: "6px", marginLeft: "1px", color: "#556275", fontSize: "13px" },
  grid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" },
  box: { background: "#fff" },
  adminBox: { padding: "17px 24px 13px 14px" },
  employeeBox: { padding: "20px 13px 17px 19px", background: "#f2fcf7" },
  h2: {
    margin: "0 0 8px 0",
  ...
  h2Emp: { color: "#246142", marginBottom: "12px" },
  row: { display: "flex", gap: "7px" },
  cardText: { marginRight: "6px" },
  h3: { margin: 0, fontSize: "16px" },
  p: { margin: "3px 0 0 0", color: "#5d6a7e", fontSize: "13px" },
  arrow: { color: "#5b6678" },
};
